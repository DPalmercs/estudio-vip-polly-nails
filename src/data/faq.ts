...
export const faqs = [
  ...
  },
  {
    ...
    answer:
      'Sim! O desconto de 15% + bônus da primeira sessão vale tanto para aplicação completa, procedimentos essenciais necessários, quanto para manutenção. Você escolhe o que precisa agora.',
  },
  {
    id: 5,
